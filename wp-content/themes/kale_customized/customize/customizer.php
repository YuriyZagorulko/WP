...
function kale_customizer_panels_sections( $wp_customize ) {
    ...
    $wp_customize->add_section( 'kale_section_frontpage_customized_header', array(
        'title'       => esc_html__( 'My banner', 'kale' ),
        'priority'    => 65,
        'panel'       => 'kale_panel_frontpage',
    ) );
...
function kale_customizer_fields( $fields ) {
    ...
    /* kale_section_customized */
    #-----------------------------------------
    $fields[] = array(
        'type'        => 'switch',
        'settings'    => 'kale_image_customized_logo_show',
        'label'       => esc_html__( 'Show Image Logo?', 'kale' ),
        'description' => esc_html__( 'Choose whether to display the image logo.', 'kale' ),
        'section'     => 'kale_section_frontpage_customized_header',
        'priority'    => 1,
        'default'     => $kale_defaults['kale_image_customized_logo_show'],
        'choices'     => array( 'on'  => esc_attr__( 'SHOW', 'kale' ), 'off' => esc_attr__( 'HIDE', 'kale' ) ),
    );
