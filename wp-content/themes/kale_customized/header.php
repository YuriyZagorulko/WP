    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="customized-row">
                <div class="logo">
                    <?php 
                    if(kale_get_option('kale_image_customized_logo_show') == 1) { 
            ...
            <?php if ( is_active_sidebar( 'header-row-1-middle' ) ) { ?>
            <!-- Header Row 1 -->
            <div class="customized-row">
                <div class="row">
                
                    <!-- Widget / Middle -->
                    <div class="col-sm-12 header-row-1-middle">
                    <?php if ( is_active_sidebar( 'header-row-1-middle' ) ) { ?><?php dynamic_sidebar( 'header-row-1-middle' ); ?><?php } ?>
                    </div>
                    <!-- /Widget / Middle -->
